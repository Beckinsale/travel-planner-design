function RecommendationsPage({ onBack }) {
  const recommendations = [
    {
      id: 1,
      route: 'Москва → Сочи → Красная Поляна',
      price: '35 000 ₽',
      time: '3ч 50м',
      temp: '+18°',
      weatherIcon: 'Sun',
    ...
    {
      id: 3,
      route: 'Иркутск → Листвянка → Ольхон',
      price: '42 000 ₽',
      time: '1ч 15м',
      temp: '-12°',
      weatherIcon: 'Cloud',
    ...
    {
      id: 4,
      route: 'Казань → Йошкар-Ола → Свияжск',
      price: '15 000 ₽',
      time: '1ч 45м',
      temp: '+12°',
      weatherIcon: 'Sun',
    ...
    {
      id: 5,
      route: 'Минводы → Кисловодск → Эльбрус',
      price: '38 000 ₽',
      time: '2ч 20м',
      temp: '+8°',
      weatherIcon: 'Sun',
